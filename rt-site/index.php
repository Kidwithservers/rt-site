...
<html>
    <head>
        ...
        <title>Rice Telecom</title>
    </head>
    <body>
        <?php include "html/header.html"; ?>
        <div class="fp-greeter">
            <video autoplay muted loop>
                <source src="img/wave-vid.mp4" type="video/mp4" />
            </video>
            <div class="caption">
                <h1>Innovative <span>Telecommunications</span> Solutions for the Most Demanding Communications Needs</h1>
            </div>
        </div>
